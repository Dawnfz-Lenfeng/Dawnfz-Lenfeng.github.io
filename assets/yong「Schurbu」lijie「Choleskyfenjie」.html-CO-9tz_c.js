import{_ as n,c as s,f as t,o as e}from"./app-ZZNa6vPs.js";const i={};function p(l,a){return e(),s("div",null,a[0]||(a[0]=[t(`<h1 id="用「schur补」理解「cholesky分解」" tabindex="-1"><a class="header-anchor" href="#用「schur补」理解「cholesky分解」"><span>用「Schur补」理解「Cholesky分解」</span></a></h1><h2 id="_1-schur-补" tabindex="-1"><a class="header-anchor" href="#_1-schur-补"><span>1. Schur 补</span></a></h2><h3 id="_1-1-定义" tabindex="-1"><a class="header-anchor" href="#_1-1-定义"><span>1.1 定义</span></a></h3><p>设<span class="math-inline" data-tex="M"></span>为<span class="math-inline" data-tex="n\\times n"></span>的矩阵, 可分块为<div class="math-block" data-tex="M=\\begin{pmatrix}
A &amp; B \\\\
C &amp; D
